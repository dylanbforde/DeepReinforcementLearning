...
class Optimizer:
    ...
    def optimize(self):
        ...
        self.optimizer.zero_grad(set_to_none=True)  # Zero the gradients (set_to_none=True reduces memory footprint)
        ...
        # Using in-place lerp_ avoids allocating intermediate tensors for performance

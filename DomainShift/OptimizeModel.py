...
class Optimizer:
    ...
    def optimize(self):
        ...
        # ⚡ Bolt Optimization: Using PyTorch's in-place .lerp_() for exponential moving averages
        # instead of explicit arithmetic (A = tau*B + (1-tau)*A) avoids intermediate tensor
        # allocations and offers a significant speedup for parameter updates.

...
class Optimizer:
    ...
    def optimize(self):
        ...
        # ⚡ Bolt Optimization: Use set_to_none=True to avoid memory allocation for zero tensors
        ...
        # ⚡ Bolt Optimization: Use in-place lerp_ for faster soft updates and reduced memory fragmentation

...
class Optimizer:
    ...
    def optimize(self):
        ...
        # Bolt: Avoid intermediate tensor allocations by using PyTorch's in-place .lerp_()
        # This replaces three tensor operations (mul, mul, add) with one optimized operation

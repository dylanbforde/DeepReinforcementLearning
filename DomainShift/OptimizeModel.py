...
class Optimizer:
    ...
    def optimize(self):
        ...
        # ⚡ Bolt Optimization: Replaced manual linear interpolation with in-place lerp_
        # to avoid intermediate tensor allocations, saving memory and improving performance.

...
class Optimizer:
    ...
    def optimize(self):
        ...
        for target_param, policy_param in zip(self.target_net.parameters(), self.policy_net.parameters()):
            # Use completely in-place linear interpolation to avoid intermediate tensor allocations
            # and significantly improve performance over `copy_` with explicit arithmetic.

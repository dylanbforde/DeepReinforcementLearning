...
class Optimizer:
    ...
    def optimize(self):
        ...
        # Set set_to_none=True to reduce memory overhead and marginally improve performance
        ...
        # Soft update the target network using in-place linear interpolation for better performance
        # This is significantly faster than the manual calculation and copy_() method

...
class Optimizer:
    ...
    def optimize(self):
        ...
        for target_param, policy_param in zip(self.target_net.parameters(), self.policy_net.parameters()):
            # Using in-place lerp_ instead of creating intermediate tensors
            # Equivalent to: target_param.data.copy_(self.TAU * policy_param.data + (1.0 - self.TAU) * target_param.data)

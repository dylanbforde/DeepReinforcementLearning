...
class Optimizer:
    ...
    def optimize(self):
        ...
        self.optimizer.zero_grad(
            set_to_none=True
        )  # Zero the gradients before the backward pass, set_to_none=True lowers memory footprint
        ...
        for target_param, policy_param in zip(
            ...
            target_param.data.lerp_(
                policy_param.data, self.TAU
            )  # In-place lerp prevents intermediate tensor allocations

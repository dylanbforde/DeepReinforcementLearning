...
class Optimizer:
    ...
    def optimize(self):
        ...
        # Bolt Performance Improvement: Use in-place .lerp_() to avoid intermediate tensor allocations
        # during the target network soft update. This is significantly faster than .copy_() with arithmetic.

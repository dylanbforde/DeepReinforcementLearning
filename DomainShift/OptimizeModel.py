...
class Optimizer:
    ...
    def optimize(self):
        ...
        # Performance: Use set_to_none=True to prevent PyTorch from allocating memory for zeroed gradients
        ...
        for target_param, policy_param in zip(self.target_net.parameters(), self.policy_net.parameters()):
            # Performance: Use in-place .lerp_() to avoid intermediate tensor allocations during soft update

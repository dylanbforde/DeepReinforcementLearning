...
class Optimizer:
    ...
    def optimize(self):
        ...
        # Performance opt: set_to_none=True avoids allocating zero-tensors, saving memory and time
        ...
        for target_param, policy_param in zip(
            ...
            # Performance opt: in-place linear interpolation (lerp_) is significantly faster than manual arithmetic

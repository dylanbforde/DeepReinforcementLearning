...
class Optimizer:
    ...
    def optimize(self):
        ...
        # Using set_to_none=True to slightly improve memory footprint and performance
        ...
        # Soft update the target network using in-place lerp_ for significant performance boost

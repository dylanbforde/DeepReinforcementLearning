...
class Optimizer:
    ...
    def optimize(self):
        ...
        # ⚡ Bolt optimization: Use set_to_none=True to reduce memory usage during backward pass
        ...
        # ⚡ Bolt optimization: Use in-place lerp_ to avoid intermediate tensor allocations
